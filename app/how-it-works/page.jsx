  ...
  const steps = [
    {
      ...
      visual: (
        <div className="bg-[#fafaf9] border border-gray-200 rounded-2xl p-4">
          ...
          <p className="text-[11px] text-gray-400 mt-3">Free forever · No credit card</p>
        </div>
      )
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="bg-[#fafaf9] px-6 py-12 border-t border-gray-100">
        ...
        <div className="flex flex-col gap-4">
          {[
            ...
            { q: "Is it really free?", a: "Yes — create your card, set up profiles, and share for free. Premium features like analytics and Apple Wallet are coming soon." },
          ].map(({ q, a }) => (
      ...
      <div className="px-6 py-14 border-t border-gray-100">
        ...
        <p className="text-[15px] text-gray-500 mb-8">Free to start. No credit card needed.</p>
        <button onClick={() => router.push("/signup")}
