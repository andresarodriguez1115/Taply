...
const STEPS = [
  { id: "hero", title: "Welcome to Taply", desc: "Your name, link, and profile creator all live up here.", position: "bottom" },
  { id: "navlink", title: "Your live link", desc: "Green dot means it's live. Anyone can visit taply.now/username right now.", position: "bottom" },
  { id: "create", title: "Create your first profile", desc: "Build a card in Business, University, Networking, or Social mode.", position: "top" },
  { id: "profiles", title: "Your profiles", desc: "Tap one to make it active — that's what your card points to.", position: "top" },
  { id: "addwallet", title: "Add to Wallet", desc: "Save your pass straight to Apple Wallet.", position: "top" },
  { id: "customize", title: "Customize your pass", desc: "Pick your colors and logo before generating.", position: "top" },
]
  ...
  return (
    <div className="fixed inset-0 z-[9999]" style={{ pointerEvents: "none" }}>
      ...
      >
        ...
        <rect width="100%" height="100%" fill="rgba(0,0,0,0.65)" mask="url(#dashboard-cut)" />
      </motion.svg>
