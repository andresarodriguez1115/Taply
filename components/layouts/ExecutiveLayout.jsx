...
{isEditing && (
          <label data-tutorial="profile-photo-btn" className="absolute -bottom-1 -right-1 w-7 h-7 bg-black rounded-full flex items-center justify-center cursor-pointer shadow z-10">
