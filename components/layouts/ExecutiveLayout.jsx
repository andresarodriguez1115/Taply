...
className="pt-0 pb-8 flex flex-col items-center w-full max-w-[380px] sm:max-w-[650px] mx-auto"    >
...
onMouseDown={bannerMouseDown}
      ...
      <div className="relative -mt-20 sm:-mt-32 group mr-60 sm:self-start sm:-ml-12">
        ...
        {/* PROFILE IMAGE */}
        <div
          className="w-[85px] h-[85px] sm:w-[170px] sm:h-[170px] rounded-full border-[2px] border-white overflow-hidden shadow-xl bg-gray-300 cursor-grab"
...
<div className="-mt-20 w-full sm:w-[650px] bg-white rounded-2xl shadow-md px-6 py-6">
  <div className="ml- 20 mt-16 text-left">
          <h1
            className="font-bold"
            style={{ fontSize: `${nameSize - 7}px` }}
          >
            {name}
          </h1>
...
>
  {title}
      ...
      {/* SAVE CONTACT BUTTON */}
<div className="mt-8 w-full sm:w-[600px] flex justify-center">
<button
